...
var _require = require('./admin-api'),
    getClientVersions = _require.getClientVersions;
...
var niceColors = ["#FF8500", "#B01124", "#99FF00", "#FFED00", "#3db0de", "#AAAAAA", "#9A989F", // 6
"#d09dfd", "#AEE5D8", "#95867F", "#80A1C1", "#BFD7B5", "#34608F", // 12
"#D3DFB8", "#C6A15B", "#720E07", "#8B6220"];

var adminRoute = function adminRoute(c, n) {
  console.log("CALLED FROM /admin/");
  if (appData.bound) bound.unbind();
  $(function () {
    $("#page-wrapper").load(pagePrefix + "/templates/admin-inner.html?v=1.3.0", function (loaded) {
      ...
      getClientVersions().then(function (clientVersions) {
        var counts = clientVersions.counts;
        var formattedData = [];
        var formattedLabels = [];
        for (var versionKey in counts) {
